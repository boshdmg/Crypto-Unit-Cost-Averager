...
describe('when buying multiple currencies',()=>{
    ...
    let config =[
        {product:"ETH-EUR",amount : "7",interval : "1"},
    ...
    it('should buy them all',()=>{
        ...
        expect(buy).toHaveBeenCalledWith("7","ETH-EUR")
        
        setInterval.mock.calls[1][0]()
        expect(buy).toHaveBeenCalledWith("7.5","LTC-EUR")

        setInterval.mock.calls[2][0]()
        expect(buy).toHaveBeenCalledWith("40","BTC-EUR")
    })
})